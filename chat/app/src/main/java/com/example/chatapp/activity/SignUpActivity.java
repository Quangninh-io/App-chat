...
public class SignUpActivity extends AppCompatActivity {
    ...
    private boolean isValidSignUpDetail(){
        ...
        else if(!binding.inputPassword.getText().toString().trim().equals(binding.inputPassword.getText().toString().trim())){
            showToast("confirm password is need to password same");
            return false;
        }else{
            return true;
        }
